            ...
            <div className="flex flex-1 flex-col gap-1">
                ...
                {isOwner && (
                  <div className="flex gap-1">
                    <button
                      ...
                      className="inline-flex items-center gap-1 rounded-full border border-emerald-400/80 bg-emerald-500/10 px-2 py-0.5 text-[11px] text-emerald-100 hover:bg-emerald-500/20"
                    >
                      <Edit2 size={12} />
                      Edit
                    </button>
              ...
              {c.contact && (
                <div className="mt-2 flex flex-wrap gap-2 text-xs">
                  <button
                    type="button"
                    onClick={() => window.open(c.contact!, '_blank')}
                    className="rounded-full border border-emerald-400 bg-emerald-500/10 px-3 py-1 text-[11px] text-emerald-100 hover:bg-emerald-500/20"
                  >
                    {linkLabel}
                  </button>
                </div>
