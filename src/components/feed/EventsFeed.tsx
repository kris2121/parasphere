...
export default function EventsFeed({
  ...
  return (
    <div className="mt-4 space-y-4">
      {/* HEADER BANNER CAROUSEL FOR EVENTS */}
      <AdSlot
      ...
      {sorted.map((ev, index) => {
        ...
        return (
          <React.Fragment key={ev.id}>
            ...
            {/* INLINE NATIVE AD AFTER 3rd EVENT */}
            {index === 2 && (
              <AdSlot
                placementKey="events-feed-inline-1"
                className="mt-2"
              />
            )}

            {/* INLINE NATIVE AD AFTER 10th EVENT */}
            {index === 9 && (
              <AdSlot
                placementKey="events-feed-inline-2"
                className="mt-2"
              />
            )}
          </React.Fragment>
